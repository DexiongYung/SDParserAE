...
class NameParser():
    ...
    def load_checkpoint(self, folder="nn_model", filename="checkpoint.pth.tar"):
        ...
        self.guide_fn.encoder.load_state_dict(name_content['guide_fn_encoder'])
        self.guide_fn.decoder.load_state_dict(name_content['guide_fn_decoder'])
        ...
        self.guide_format.transformer.load_state_dict(format_content['guide_format'])
